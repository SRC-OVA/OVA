...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua OVA.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://black-source.tk/Dr/index.php?bn=OVA&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://brok-aapi.ml/API/RSU.php?id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token"))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua OVA.lua')
end 
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./OVA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-OVA/Files_OVA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1214622341,1214622341}   
...
local hash = database:sismember(bot_id.."Dev:BROK:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevBROK(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."PPPPZ:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBROK(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1444037923) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:BROK:2", user_id) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'PPPPZ:MN:TF'..chat_id, user_id) then
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 OVA.")  
...
function plugin_OVA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.OVA and msg then
pre_msg = plugin.OVA(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceOVA(msg,data) -- بداية العمل
if msg then
...
if DevBROK(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,OVA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ℘' and DevBROK(msg) then  
...
if text == 'تعطيل التواصل ℘' and DevBROK(msg) then  
...
if text == 'ضع كليشه ستارت ℘' and DevBROK(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ℘︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ℘' and DevBROK(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ℘' and DevBROK(msg) then 
...
if text == 'تحديث السورس ℘' and DevBROK(msg) then 
os.execute('rm -rf OVA.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-OVA/OVA/main/OVA.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس اوفا\n ℘︙ الاصدار » { v 1.6 }')
dofile('OVA.lua')  
end
if text == 'الاصدار ℘' and DevBROK(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس اوفا \n ℘︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ℘" and DevBROK(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ℘' and DevBROK(msg) then 
...
if text == 'المشتركين ℘' and DevBROK(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ℘' and DevBROK(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ℘") and DevBROK(msg) then
...
if text == ("الثانويين ℘") and DevBROK(msg) then
local list = database:smembers(bot_id..'Dev:BROK:2')
t = "\n ℘︙ قائمة الثانويين \nٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "🐉 حصريات و تحديثات دراكـون 🐉" and DevBROK(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس اوفا*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇OVA 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/PPPPD"}},
}
...
-----------
if text == ("قائمه العام ℘") and DevBROK(msg) then
...
if text == ("قائمه الكتم العام ℘") and DevBROK(msg) then
...
if text=="اذاعه خاص ℘" and msg.reply_to_message_id_ == 0 and DevBROK(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ℘" and msg.reply_to_message_id_ == 0 and DevBROK(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ℘" and msg.reply_to_message_id_ == 0 and DevBROK(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ℘" and msg.reply_to_message_id_ == 0  and DevBROK(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ℘" and msg.reply_to_message_id_ == 0  and DevBROK(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ℘' and DevBROK(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..OVAk..''..OVA..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local OVA1_Msg = database:get(bot_id.."OVA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if OVA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if OVA_Msg and not Special(msg) then  
local OVA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if OVA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBROK(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBROK(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBROK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBROK(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ℘" and DevBROK(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ℘︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ℘$") and DevBROK(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ℘" and DevBROK(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ℘" and DevBROK(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ℘︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ℘" and DevBROK(msg) then  
...
database:sadd(bot_id.."OVA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."OVA:blocname"..msg.chat_id_)
...
function PPPPZ_name(t1,t2)
if t2.id_ then 
name_MRBROK = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRBROK then 
names_MRBROK = database:smembers(bot_id.."OVA:blocname"..msg.chat_id_) or ""
if names_MRBROK and names_MRBROK[1] then 
for i=1,#names_MRBROK do 
if name_MRBROK:match("(.*)("..names_MRBROK[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, PPPPZ_name)
end
...
database:set(bot_id.."OVA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."OVA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."OVA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."OVA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."OVA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function BROK_mrBROK_new(mrBROK1,mrBROK2)
if mrBROK2 and mrBROK2.first_name_ then 
if mrBROK2.first_name_:match("(.*)"..database:get(bot_id.."OVA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."OVA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrBROK_nnn = database:get(bot_id.."OVA:nump"..msg.chat_id_) or 5
local mrBROK_nnn2 = database:get(bot_id.."OVA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrBROK_nnn2) == tonumber(mrBROK_nnn) or tonumber(mrBROK_nnn2) > tonumber(mrBROK_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."OVA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrBROK2.username_.."](https://t.me/"..(mrBROK2.username_ or "PPPPD")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."OVA:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrBROK_nnn) - tonumber(mrBROK_nnn2)).."}")
end
end
end
end
bnnaGet(id, BROK_mrBROK_new)
end
end
...
local OVAChengName = database:get(bot_id.."OVA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if OVAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..OVAChengName..']')
database:del(bot_id.."OVA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if OVAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."OVA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local OVAChengUserName = database:get(bot_id.."OVA:Cheng:UserName"..data.id_)
if not data.username_ then 
if OVAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..OVAChengUserName..']')
database:del(bot_id.."OVA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if OVAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."OVA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local OVAChengPhoto = database:get(bot_id.."OVA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if OVAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."OVA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if OVAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."OVA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE OVA ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/PPPPD)
℘︙ [Source Update ](t.me/PPPPD)     
℘︙ [Source developer](t.me/PPPPZ)     

┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS OVA](t.me/Yv4BoT)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevBROK(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("مسح قائمه العام") and DevBROK(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBROK(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBROK(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBROK(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBROK(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBROK(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBROK(msg) then
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."PPPPZ:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'PPPPZ:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,BROK)
x = 0
tags = 0
...
if text == 'الملفات' and DevBROK(msg) then
t = ' ℘︙ ملفات السورس اوفا ↓\n ٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevBROK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-OVA/Files_OVA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات اوفا\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevBROK(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-OVA/Files_OVA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('OVA.lua')  
else
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس اوفا \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevBROK(msg) then
...
if text == "مسح الملفات" and DevBROK(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ℘︙ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBROK(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBROK(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:BROK'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:BROK'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:BROK'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:BROK'..msg.chat_id_,true)  
Text = '\n ℘︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:BROK'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-OVA")
...
function Function_OVA(extra, result, success)
database:sadd(bot_id.."Dev:BROK:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","℘︙ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_OVA, nil)
return false 
end
...
function Function_OVA(extra, result, success)
database:srem(bot_id.."Dev:BROK:2", result.sender_user_id_)
...
function Function_OVA(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:BROK:2", result.id_)
...
database:srem(bot_id.."Dev:BROK:2", userid)
...
database:del(bot_id.."Dev:BROK:2")
...
database:del(bot_id..'PPPPZ:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'PPPPZ:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPPD')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'PPPPD')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPPD')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPPD')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'PPPPD')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PPPPD')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
database:set(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."OVA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."OVA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."OVA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."OVA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."OVA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OVA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."OVA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."OVA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."OVA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OVA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."OVA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local OVA_Msg = database:get(bot_id.."OVA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..OVA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBROK(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ℘︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBROK(msg) then
...
if text == 'تفعيل الاذاعه' and DevBROK(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBROK(msg) then  
...
if not database:get(bot_id..'PPPPZ:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'PPPPZ:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."PPPPZ:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."PPPPZ:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."PPPPZ:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."PPPPZ:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوفا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اوفا')
local OVA_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..OVA_Msg[math.random(#OVA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBROK(msg) then 
...
if database:sismember(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:srem(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:BROK:2',msg.sender_user_id_) then
database:srem(bot_id..'PPPPZ:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevBROK(msg) then 
...
if text == ("ردود المطور") and DevBROK(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n℘︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevBROK(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevBROK(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:OVA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:OVA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OVA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:OVA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:OVA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:OVA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:OVA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:OVA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:OVA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:OVA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:OVA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:OVA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:OVA:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 OVA.',url="t.me/PPPPD"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس اوفا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:OVA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:OVA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OVA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OVA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OVA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OVA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:OVA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OVA:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:OVA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:OVA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:OVA:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوفا').." غادر" or text == 'بوت غادر' then  
...
if text == 'تفعيل المغادره' and DevBROK(msg) then   
...
if text == 'تعطيل المغادره' and DevBROK(msg) then  
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,BROK,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (BROK.total_count_ or 0)
...
local rdphoto = BROKa[math.random(#BROKa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, BROK.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
OVAdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
database:set(bot_id..'id:user'..msg.chat_id_,BROK)  
...
BROK = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,BROK)  
...
if text == 'استعاده الاوامر' and DevBROK(msg) then
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/PPPPD"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/BROK"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." BROK:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الزغرفه')
database:set(bot_id.." BROK:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." BROK:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ RSU ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 OVA. ](t.me/PPPPD)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '℘︙ تم تعطيل الابراج')
database:set(bot_id.." BROK:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الابراج')
database:set(bot_id.." BROK:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." BROK:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." BROK:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '℘︙ تم تعطيل حساب العمر')
database:set(bot_id.." BROK:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." BROK:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." BROK:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BROK:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الافلام')
database:set(bot_id.."BROK:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."BROK:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اوفا')
...
OVA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(OVA)
...
--------------------------------------------------------------------------------------------------------------
SourceOVA(data.message_,data)
plugin_OVA(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local OVAAbot = database:get(bot_id.."OVA1:Add:Filter:Rp2"..text..result.chat_id_)   
if OVAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..OVAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local OVA1_Msg = database:get(bot_id.."OVA1:Add:Filter:Rp2"..text..result.chat_id_)   
if OVA1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..OVA1_Msg)
...
end -- end new msg dev.mr BROK 
end -- end callback dev.mr BROK
